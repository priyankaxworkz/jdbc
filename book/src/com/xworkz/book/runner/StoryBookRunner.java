...
public class StoryBookRunner {
	public static void main(String[] args) {
		...
		try(Connection connection=DriverManager.getConnection(ConnectionData.URL.getValue(),
			...
			String query="insert into book_details values('a london adventures',300)";
			String query1="update book_details set book_name='stationeleven' where book_name='a london adventures'";
