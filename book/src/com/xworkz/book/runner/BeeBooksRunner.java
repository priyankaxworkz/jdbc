...
public class BeeBooksRunner {
	public static void main(String[] args) {
		...
		try(Connection connection=DriverManager.getConnection(ConnectionData.URL.getValue(),
			...
			String query="insert into book_details values('apair of blue eyes',300)";
			String query1="update book_details set book_name='emergency' where book_name='apair of blue eyes'";
