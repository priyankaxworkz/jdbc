...
public class HistoryBookRunner {
	public static void main(String[] args) {
		try(Connection connection=DriverManager.getConnection(ConnectionData.URL.getValue(),
			...
			String query="insert into book_details values('jj',350)";
			String query1="update book_details set book_name='little prince' where book_name='jj'";
