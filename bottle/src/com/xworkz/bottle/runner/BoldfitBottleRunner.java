...
public class BoldfitBottleRunner {
	public static void main(String[] args) {
		...
		Statement statement=connection.createStatement()){
			...
			String query="insert into bottle_info values('jug',60)";
			String query1="update bottle_info set bottle_name='boldfit' where bottle_name='jug'";
