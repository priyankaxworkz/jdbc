...
public class MacallanBottleRunner {
	public static void main(String[] args) {
		...
		Statement statement=connection.createStatement()){
			...
			String query="insert into bottle_info values('stello',450)";
			String query1="update bottle_info set bottle_name='macallan' where bottle_name='stello'";
