...
public class BorosilBottleRunner {
	...
	public static void main(String[] args) {
		...
		Statement statement=connection.createStatement()){
			...
			String query="insert into bottle_info values('fruity',60)";
			String query1="update bottle_info set bottle_name='borosil' where bottle_name='fruity'";
