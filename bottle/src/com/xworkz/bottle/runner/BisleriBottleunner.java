...
public class BisleriBottleunner {
	public static void main(String[] args) {
		...
		Statement statement=connection.createStatement()){
			...
			String query="insert into bottle_info values('flask',50)";
			String query1="update bottle_info set bottle_name='milton' where bottle_name='flask'";
