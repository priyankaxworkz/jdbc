...
public class IncrizmaBottleRunner {
	...
	public static void main(String[] args) {
		...
		Statement statement=connection.createStatement()){
			...
			String query="insert into bottle_info values('kuber',50)";
			String query1="update bottle_info set bottle_name='thermal' where bottle_name='kuber'";
