...
public class KuberBottleRunner {
	public static void main(String[] args) {
		...
		Statement statement=connection.createStatement()){
			...
			String query="insert into bottle_info values('pepsi',350)";
			String query1="update bottle_info set bottle_name='prestige' where bottle_name='pepsi'";
