...
public class ActonPenRunner {
	public static void main(String[] args) {
		...
		String query="insert into pen_info values('orange',20)";
		String query1="update pen_info set pen_name='ellisbell'where pen_name='orange'";
