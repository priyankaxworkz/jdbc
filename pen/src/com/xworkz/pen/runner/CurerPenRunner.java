...
public class CurerPenRunner {
	...
	public static void main(String[] args) {
		...
		String query="insert into pen_info values('mark twain',5)";
		String query1="update pen_info set pen_name='nataraja' where pen_name='mark twain'";
